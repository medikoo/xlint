...
var remove   = require('es5-ext/lib/Array/prototype/remove')
  ...
  , toArray  = require('es5-ext/lib/Object/map-to-array')
...
Reporter.prototype = Object.create(Base.prototype, extend({
	init: d(function () {
		var reports = {}, waiting = [];
...
}, { method: 'logReports' }), memoize(function () {
	nextTick(function () {
...
module.exports = exports = function (report/*, options*/) {
	deferred.validPromise(report[0]);
	return (new Reporter(report[0], Object(arguments[1]))).init();
};
