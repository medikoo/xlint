...
LintFile.prototype = {
	...
	getOptions: function () {
		this.optsPromise = this.readOptions().aside(function (options) {
	...
	readOptions: function () {
		return readOptions(this.filename, this.watch);
	},
	getSrc: function () {
		var onend = function () {
...
module.exports = exports = function (filename/*, options, cb*/) {
	...
	if ((cb == null) && isCallable(options)) {
		...
		options = { watch: options.watch, cache: options.cache, options: options };
		delete options.options.cache;
		delete options.options.watch;
	}
